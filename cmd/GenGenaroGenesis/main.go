...
func main() {
	...
	committees = append(committees, common.StringToAddress("0xb77a75699c3707fBede9442db8451F44321ef83f"))
	committees = append(committees, common.StringToAddress("0x81Cee7d346595e0552c6df38DD3F61F6e5802d10"))
	committees = append(committees, common.StringToAddress("0x1A7194Eb140e29e09FCe688d2E86f282D6a83E69"))
	committees = append(committees, common.StringToAddress("0x77F7C5FDE3Ce4Fa137c48B3f722B17D7722c3924"))
	committees = append(committees, common.StringToAddress("0xd31Eb2eA2D7bC15c5B0FE7922fAB4Db0A4F8187A"))
	...
	icos = append(icos, common.StringToAddress("0xA386b786132Efe05B56E3717f556dDe0aD79C6Ed")) // 100
	icos = append(icos, common.StringToAddress("0x362AB90e24c98E3eC83AfDA2cC702a5E24e8025b")) // 200
	icos = append(icos, common.StringToAddress("0xF3719a8EE4a18623D4dB1d879Ba605daaF509B79")) // 300
	icos = append(icos, common.StringToAddress("0xf6Fe19Fc7310E1cBcF8Be9901fF870ddc9bB9bf8")) // 400
	icos = append(icos, common.StringToAddress("0xd350b3f1F0B74813577BA7e68c6e5f08c917603d")) // 500
	...
	stakes = append(stakes, common.StringToAddress("0xf8c93eBA49Eae0D74CDA7AA794a95998A927785e")) // 100
	stakes = append(stakes, common.StringToAddress("0x77a965FfCC8B456BF843A3bBF54971ba4B973C2C")) // 200
	stakes = append(stakes, common.StringToAddress("0xaD8D137FbE0dDDE9E395859c45bB76508b878C2F")) // 300
	stakes = append(stakes, common.StringToAddress("0xc132Ab73Fc66F8C890C30E13678d8Aa0145b355B")) // 400
	stakes = append(stakes, common.StringToAddress("0x2f6D35a6b982403dbaC687993B7A2b9d938FCdda")) // 500
	...
	hefts = append(hefts, common.StringToAddress("0xfd8a875eb1e3aF2E5578e638E75c36B3749c5DC2")) // 100
	hefts = append(hefts, common.StringToAddress("0x1D0F6DD944C6a3749a38871243d2F76Dbe71886F")) // 200
	hefts = append(hefts, common.StringToAddress("0x2aD36f60E663C4a32D45fbBc58319679BAbF3cC0")) // 300
	hefts = append(hefts, common.StringToAddress("0x2C162771fd8174621b2B02FCA92304b6c5BF068E")) // 400
	hefts = append(hefts, common.StringToAddress("0x6248B095bf7ae01c5e16A32f1E430f2858c07928")) // 500
